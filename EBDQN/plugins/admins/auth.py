...
from EBDQN.utilities.config import BANNED_USERS, adminlist
from EBDQN.utilities.strings import get_command
from EBDQN import bot
from EBDQN.modules.main.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from EBDQN.modules.main.decorators import AdminActual
