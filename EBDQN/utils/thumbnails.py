...
from EBDQN.resource import thumbs, colors
from EBDQN.utilities.config import YOUTUBE_IMG_URL
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"EBDQN/resource/{images}.png")
        ...
        font = ImageFont.truetype("EBDQN/resource/font2.ttf", 45)
        ImageFont.truetype("EBDQN/resource/font2.ttf", 70)
        arial = ImageFont.truetype("EBDQN/resource/font2.ttf", 30)
        ImageFont.truetype("EBDQN/resource/font.ttf", 30)
