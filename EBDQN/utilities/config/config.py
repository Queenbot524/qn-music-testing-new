...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "EBD ~ QN")
OWNER_ID = list(map(int, getenv("OWNER_ID", "1476655690").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Queenbot524/qn-music-testing-new")
...
if PING_IMG_URL:
    if PING_IMG_URL != "EBDQN/resource/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://te.legra.ph/file/6abc32c3858f205434cd5.jpg"

if START_IMG_URL:
    if START_IMG_URL != "EBDQN/resource/Ping.jpeg":
