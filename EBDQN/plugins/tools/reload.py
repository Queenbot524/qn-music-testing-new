...
from EBDQN.utilities.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
...
from EBDQN.modules.main.database import get_authuser_names, get_cmode
from EBDQN.modules.main.decorators import (ActualAdminCB, AdminActual,
                                         language)
