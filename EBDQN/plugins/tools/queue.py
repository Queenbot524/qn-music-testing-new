...
from EBDQN.utilities.config import config
...
from EBDQN.modules.main.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from EBDQN.modules.main.decorators.language import language, languageCB
from EBDQN.utilities.inline import queue_back_markup, queue_markup
