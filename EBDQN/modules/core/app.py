...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("EBD_QN")
                await self.one.join_chat("EBD_QN_CHAT")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("EBD_QN")
                await self.one.join_chat("EBD_QN_CHAT")
                await self.one.join_chat("QUEEN_SUPPORTS_CHAT")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("EBD_QN")
                await self.one.join_chat("EBD_QN_CHAT")
                await self.one.join_chat("QUEEN_SUPPORTS_CHAT")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("EBD_QN")
                await self.one.join_chat("EBD_QN_CHAT")
                await self.one.join_chat("QUEEN_SUPPORTS_CHAT")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("EBD_QN")
                await self.one.join_chat("EBD_QN_CHAT")
                await self.one.join_chat("QUEEN_SUPPORTS_CHAT")
            except:
                pass
